    ...
    <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="form-offcanvas" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <div class="form-group">
          ...
          <Multiselect id="tags" v-model="tags" :multiple="true" :value="tags" placeholder="Enter Tags" v-bind="multiSelectOption" :options="tags_list.options" class="form-group"> </Multiselect>
...
onMounted(() => {
  ...
  quillInstance.on('text-change', () => {
    ...
    const strippedContent = content.replace(/<p>(&nbsp;|\s)*<\/p>/g, '').trim()
