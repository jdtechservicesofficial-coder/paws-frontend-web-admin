...
class BookingVeterinaryResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'duration' => optional($this->veterinary)->duration,
            'reason' => optional($this->veterinary)->reason,
            'address' => optional($this->veterinary)->address,
            ...
            'customer_address' => new AddressResource(optional($this->user)->userAddress),
            'taxes' => $tax_details,
