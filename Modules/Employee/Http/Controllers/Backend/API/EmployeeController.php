...
class EmployeeController extends Controller
{
    ...
    $employee = User::select('users.*')->branch()->with('media', 'mainBranch','boarderdaycareamount')->whereNotNull('email_verified_at');
    ...
    if(!empty($request->type)){
        ...
        // Exclude admin and user roles to only fetch staff/employees
        $employee = $employee->whereNotIn('user_type', ['admin', 'demo_admin', 'user']);
    }
