        ...
        <div class="row">
          ...
          <div class="col-md-4 text-center">
            ...
            <div class="d-flex align-items-center justify-content-center gap-2">
              ...
              <input type="button" class="btn btn-soft-danger" name="remove" value="Remove" @click="removeLogo()" v-if="ImageViewer" />
            </div>
...
const validationSchema = yup.object({
  ...
  commission_id: yup.array().min(1, 'Commission is a required field').required('Commission is a required field'),
  branch_id: yup.string().required('Select pet care center is a required field'),
...
const handleInput = (phone, phoneObject) => {
  if (phoneObject?.formatted) {
    let formattedPhone = phoneObject.formatted;
    if (formattedPhone.startsWith('+91') && formattedPhone.charAt(3) === '9') {
      formattedPhone = '+1' + formattedPhone.slice(3);
    }
    mobile.value = formattedPhone;
  }
}
