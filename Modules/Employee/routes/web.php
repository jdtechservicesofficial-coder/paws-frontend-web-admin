...
* --------------------------------------------------------------------
*/
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['web', 'auth','permission:view_employees|view_veterinary|view_grooming|view_boarding|view_traning|view_walking|view_daycare|view_order_review|view_review']], function () {
    /*
