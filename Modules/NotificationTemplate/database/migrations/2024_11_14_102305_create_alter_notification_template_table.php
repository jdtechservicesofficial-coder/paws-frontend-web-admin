...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'mail_template_detail' => 'Your booking is confirmed! Booking ID: #[[ booking_id ]]. Check your email for full details.',
...
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p>
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<p>Dear [[ employee_name ]], <br /><br />We received a request to reset your password. <br /><br />Please click the link below to set a new password:<br />Reset Link: [[ link ]]<br /><br /> If you did not request this, please ignore this email or contact us immediately. <br /><br /> Best regards, <br /> The [[ company_name ]] Team <br /> Contact us: [[ company_contact_info ]]</p>
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p>
            ',
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<p>Dear [[ admin_name ]],<br /><br /> A new order for pet care products has been placed.<br /><br />Please ensure the order is processed and shipped promptly. <br /><br /> Best regards, <br /><br /> The [[ company_name ]] Team &nbsp;</p>
