...
class NotificationTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #f8f9fa; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; padding: 40px 0;\"><tr><td align=\"center\"><table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;\"><tr><td style=\"background-color: #ff9800; padding: 30px; text-align: center;\"><h1 style=\"color: #ffffff; margin: 0; font-size: 24px;\">[[ company_name ]]</h1></td></tr><tr><td style=\"padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;\"><p>Dear [[ admin_name ]],<br /><br /> We are pleased to inform you that your appointment has been successfully confirmed with [[ company_name ]]! Thank you for choosing us &ndash; we are excited to serve you and ensure you and your pet have a fantastic experience. <br /><br />Here are the details of your appointment: <br /><br />📅 Appointment Details: <br />- Appointment ID: #[[ booking_id ]] - Service/Event: [[ booking_services_names ]]<br />- Date: [[ booking_date ]] <br />- Time: [[ booking_time ]] <br />- Location: [[ venue_address ]] <br /><br />We&rsquo;ve received your appointment and everything is set. Our team is preparing to deliver an amazing service, and we want to make sure all your expectations are met. If you have any questions or specific requests, feel free to reach out to us. <br /><br />Tip: Don't forget to mark your calendar and set a reminder for your appointment! <br /><br />We appreciate your trust in us and look forward to providing top-notch service. For any further queries, our customer support team is here to assist you.<br /><br />Best regards,<br />[[ logged_in_user_fullname ]], <br />[[ logged_in_user_role ]],<br />[[ company_name ]]</p></td></tr><tr><td style=\"background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;\"><p style=\"margin: 0;\">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style=\"margin: 5px 0 0;\">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>",
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'status' => 1,
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Hello [[ employee_name ]],<br /><br /> You have been assigned a new booking scheduled for [[ booking_date ]] at [[ booking_time ]]. <br /><br />📋 Booking Details: <br />- Booking ID: #[[ booking_id ]] <br />- Customer Name: [[ user_name ]] <br />- Services: [[ booking_services_names ]] <br />- Duration: [[ booking_duration ]] <br />- Address: [[ venue_address ]] <br /><br /> Please prepare accordingly and confirm the booking in your dashboard. <br /><br /> Regards, <br /> [[ company_name ]]</p></td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Hello [[ user_name ]],<br /><br /> Thank you for choosing [[ company_name ]] for your pet care needs! Your booking has been confirmed. <br /><br /> 📋 Booking Details:<br /> - Booking ID: #[[ booking_id ]] <br />- Date &amp; Time: [[ booking_date ]] at [[ booking_time ]] <br />- Services: [[ booking_services_names ]] <br />- Duration: [[ booking_duration ]] <br />- Assigned Staff: [[ employee_name ]] <br />- Address: [[ venue_address ]] If you have any questions, please reach out to us. <br /><br /> Thank you, <br /> [[ company_name ]]</p></td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #f8f9fa; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; padding: 40px 0;\"><tr><td align=\"center\"><table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;\"><tr><td style=\"background-color: #ff9800; padding: 30px; text-align: center;\"><h1 style=\"color: #ffffff; margin: 0; font-size: 24px;\">[[ company_name ]]</h1></td></tr><tr><td style=\"padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;\"><p>Dear [[ user_name ]],<br /><br /> Your booking has been successfully accepted! We're excited to welcome you and hope you enjoy your time with us. <br /><br /> Booking Details: <br />- Booking ID: #[[ booking_id ]]<br />- Booking Date: [[ booking_date ]] <br />- Booking Time: [[ booking_time ]] <br /><br /> We look forward to hosting you and ensuring you have a pleasant experience. If you have any questions or need assistance, don't hesitate to reach out to us. <br /><br /> Best regards, <br /> The [[ company_name ]] Team <br /> Contact: [[ company_contact_info ]]</p>
            </td></tr><tr><td style=\"background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;\"><p style=\"margin: 0;\">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style=\"margin: 5px 0 0;\">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>",
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
           ...
           <p dir="ltr">New booking accepted: ID #[[ booking_id ]] from [[ user_name ]]. Review the details in your admin panel.</p>',
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ admin_name ]], <br /><br /> A new booking has been accepted! Please review the details below. <br /><br /> Booking Details: <br /><br />- Booking ID: #[[ booking_id ]] <br />- User Name: [[ user_name ]] <br />- Booking Date: [[ booking_date ]] <br />- Booking Time: [[ booking_time ]] <br /><br /> If you need further details or assistance, please contact us. <br /><br /> Best regards, <br /> The [[ company_name ]] Team <br /> Contact: [[ company_contact_info ]]</p>
...
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p>
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ user_name ]],</p>
...
<p>[[ company_contact_info ]]</p>
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ user_name ]], <br /><br /> We regret to inform you that your booking has been cancelled. We apologize for any inconvenience this may have caused.</p>
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ employee_name ]],<br /><br />A booking has been cancelled. Please review the details below.<br /><br />Booking Details:<br />- Booking ID: #[[ booking_id ]]<br />- User Name: [[ user_name ]]<br />- Service: [[ booking_services_names ]]<br />- Date: [[ booking_date ]]<br />- Time: [[ booking_time ]]<br />- Location: [[ venue_address ]]<br /><br />Please take the necessary actions as required.<br />Best regards,<br />The [[ company_name ]] Team<br />Contact: [[ company_contact_info ]]</p>
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'subject' => 'Booking Cancelled',
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"> <p>Dear [[ admin_name ]],<br /><br /> A booking has been cancelled. Please review the details below.<br /><br /> Booking Details: <br />- Booking ID: #[[ booking_id ]] <br />- User Name: [[ user_name ]] <br />- Service: [[ booking_services_names ]] <br />- Date: [[ booking_date ]] <br />- Time: [[ booking_time ]] <br />- Location: [[ venue_address ]] <br /><br /> Please take the necessary actions as required.<br />Best regards, <br /> The [[ company_name ]] Team <br /> Contact: [[ company_contact_info ]]</p></td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"> <p>Dear [[ admin_name ]], <br /><br /> A new booking request has been accepted. Please review the details below. <br /><br /> Booking Details:<br /> - Booking ID: #[[ booking_id ]] <br />- User Name: [[ user_name ]] <br />- Service(s): [[ booking_services_names ]] <br />- Date: [[ booking_date ]] <br />- Time: [[ booking_time ]] <br />- Duration: [[ booking_duration ]] <br />- Venue: [[ venue_address ]]<br /> <br /> Best regards, <br /> The [[ company_name ]] Team <br />Contact us: [[ company_contact_info ]]</p></td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
...
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p>
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ admin_name ]],<br /><br /> A user has successfully changed their password. Please review the details below: <br /><br /> User ID: [[ user_id ]] <br /> User Name: [[ user_name ]]<br /><br /> If this change was unauthorized, please investigate further. <br /><br /> Best regards, <br /> The [[ company_name ]] Team <br /> Contact us: [[ company_contact_info ]]</p>
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p>
            </td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
...
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p>
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ employee_name ]], <br /><br /> Your password has been successfully changed. <br /><br />If you did not request this change, please contact us immediately. <br /><br />For any concerns, reach out to us at [[ company_contact_info ]]. <br /><br /> Best regards, <br />The [[ company_name ]] Team</p>
            </td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'mail_subject' => 'Password Changed Successfully',
            'mail_template_detail' => "<p>Your password has been updated. If this wasn't you, contact support immediately.</p>",
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ user_name ]], <br /><br /> Your password has been successfully changed.<br /><br /> If you did not request this change, please contact us immediately.<br /><br /> For any concerns, reach out to us at [[ company_contact_info ]]. <br /><br /> Best regards, <br /> The [[ company_name ]] Team</p>
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Thank you for choosing us for your recent order. We are delighted to confirm that your order has been successfully placed!</p>
            </td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ admin_name ]], <br /><br />A user has requested a password reset.<br /><br /> Please review the details below: <br /> User ID: [[ user_id ]]<br />User Name: [[ user_name ]] <br /><br />If this request seems suspicious, please investigate. <br /><br /> Best regards,<br /> The [[ company_name ]] Team <br /> Contact: [[ company_contact_info ]]</p>
            </td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
...
',
            ...
            'template_detail' => "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #f8f9fa; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; padding: 40px 0;\"><tr><td align=\"center\"><table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;\"><tr><td style=\"background-color: #ff9800; padding: 30px; text-align: center;\"><h1 style=\"color: #ffffff; margin: 0; font-size: 24px;\">[[ company_name ]]</h1></td></tr><tr><td style=\"padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;\"><p>Dear [[ user_name ]], <br />|<br />We are excited to let you know that your order for pet care products is now being processed! <br /><br />Our team is getting everything ready to ship your items as quickly as possible. <br /><br /> We will notify you as soon as your order ships. If you have any questions or need assistance, don't hesitate to contact us.<br /><br /> Thank you for shopping with [[ company_name ]]! <br /><br /> Best regards, <br /> The [[ company_name ]] Team<br /> Contact us: [[ company_contact_info ]]</p></td></tr><tr><td style=\"background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;\"><p style=\"margin: 0;\">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style=\"margin: 5px 0 0;\">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>",
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ admin_name ]],<br /><br /> The order for pet care products is now being processed.<br /><br /> Below are the details for your review: Customer Name: [[ user_name ]] <br /><br /> Please ensure the processing steps continue smoothly and take the necessary actions for fulfillment. <br /><br /> Best regards, <br /> The [[ company_name ]] Team<br /> Contact: [[ company_contact_info ]]</p>
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p></td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
...
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p></td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'template_detail' => "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #f8f9fa; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; padding: 40px 0;\"><tr><td align=\"center\"><table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;\"><tr><td style=\"background-color: #ff9800; padding: 30px; text-align: center;\"><h1 style=\"color: #ffffff; margin: 0; font-size: 24px;\">[[ company_name ]]</h1></td></tr><tr><td style=\"padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;\"><p>Dear [[ admin_name ]],<br /> <br /> The order for pet care products has been successfully delivered to the customer.&nbsp;<br /><br />Here are the details: <br />Customer Name: [[ user_name ]] <br /><br /> Please update the records accordingly.<br /> <br />If there are any issues, please address them promptly. <br /><br /> Best regards, <br /> The [[ company_name ]] Team<br /> Contact: [[ company_contact_info ]]</p>
</td></tr><tr><td style=\"background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;\"><p style=\"margin: 0;\">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style=\"margin: 5px 0 0;\">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>",
        ]);
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'subject' => 'Order Delivered - Confirmation for Pet Care Products',
            'template_detail' => '<table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; padding: 40px 0;"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;"><tr><td style="background-color: #ff9800; padding: 30px; text-align: center;"><h1 style="color: #ffffff; margin: 0; font-size: 24px;">[[ company_name ]]</h1></td></tr><tr><td style="padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;"><p>Dear [[ admin_name ]], <br /><br /> The order for pet care products has been successfully delivered to the customer. <br /><br />Here are the details: <br />Customer Name: [[ user_name ]] <br /><br /> Please update the records accordingly. If there are any issues, please address them promptly. <br /><br /> Best regards, <br /> The [[ company_name ]] Team<br /> Contact: [[ company_contact_info ]]</p>
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p></td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
        ]);
...
<p><span style="font-family: Arial; font-size: 13px; white-space-collapse: preserve;">&nbsp;</span></p></td></tr><tr><td style="background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;"><p style="margin: 0;">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style="margin: 5px 0 0;">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>',
    ...
    $template->defaultNotificationTemplateMap()->create([
        ...
        'template_detail' => "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #f8f9fa; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; padding: 40px 0;\"><tr><td align=\"center\"><table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" style=\"background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05); overflow: hidden;\"><tr><td style=\"background-color: #ff9800; padding: 30px; text-align: center;\"><h1 style=\"color: #ffffff; margin: 0; font-size: 24px;\">[[ company_name ]]</h1></td></tr><tr><td style=\"padding: 40px; color: #333333; line-height: 1.6; font-size: 16px;\"><p>Dear [[ admin_name ]], <br /><br /> An order has been cancelled. <br />Below are the details: <br />Customer Name: [[ user_name ]] <br /><br /> Please review the cancellation and update the records accordingly. <br />If further action is needed, please address it promptly. <br /><br /> Best regards, <br /> The [[ company_name ]] Team <br /> Contact: [[ company_contact_info ]]</p>
</td></tr><tr><td style=\"background-color: #f1f1f1; padding: 20px; text-align: center; color: #777777; font-size: 12px;\"><p style=\"margin: 0;\">&copy; 2024 [[ company_name ]]. All rights reserved.</p><p style=\"margin: 5px 0 0;\">[[ company_contact_info ]]</p></td></tr></table></td></tr></table>",
    ]);
