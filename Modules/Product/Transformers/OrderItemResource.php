...
class OrderItemResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'customer_contact' => optional(optional($this->order)->user)->mobile,
            'customer_image' => optional(optional($this->order)->user)->getFirstMediaUrl('profile_image') ?: default_user_avatar(),
            'order_date' => $this->created_at ? Carbon::parse($this->created_at)->timezone($timezone)->format('Y-m-d H:i:s') : null,
