...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::post('admin/update-product/{id}', [ProductsController::class, 'updateProduct']);
    Route::post('admin/update-product-status/{id}', [ProductsController::class, 'updateStatus']);
    ...
    Route::get('order-invoice-download', [Modules\Product\Http\Controllers\Backend\OrdersController::class, 'downloadInvoice']);
