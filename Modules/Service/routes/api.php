...
Route::get('system-service-list', [ServiceController::class, 'systemServiceList']);
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::post('admin/update-service-status/{id}', [ServiceController::class, 'updateServiceStatus']);
    Route::post('admin/update-system-service-status/{id}', [ServiceController::class, 'updateSystemServiceStatus']);
    Route::post('admin/update-system-service/{id}', [ServiceController::class, 'updateSystemService']);
