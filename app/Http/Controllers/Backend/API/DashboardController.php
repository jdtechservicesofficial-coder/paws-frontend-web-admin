...
class DashboardController extends Controller
{
    public function dashboardDetail(Request $request)
    {
        ...
        $petsitter = setting('show_pet_sitter') == '1' ? User::where('status',1)->where('user_type','pet_sitter')->take(5)->get() : [];
        $groomer = setting('show_groomer') == '1' ? User::where('status',1)->where('user_type','groomer')->take(5)->get() : [];
        $boarder = setting('show_boarder') == '1' ? User::where('status',1)->where('user_type','boarder')->take(5)->get() : [];
        $vet = setting('show_vet') == '1' ? User::where('status',1)->where('user_type','vet')->take(5)->get() : [];
        $trainer = setting('show_trainer') == '1' ? User::where('status',1)->where('user_type','trainer')->take(5)->get() : [];
        $walker = setting('show_walker') == '1' ? User::where('status',1)->where('user_type','walker')->take(5)->get() : [];
        $day_taker = setting('show_day_taker') == '1' ? User::where('status',1)->whereIn('user_type',['day_taker','dayCare_taker'])->take(5)->get() : [];
        ...
        \Modules\Event\Models\Event::where('status', 1)->where('date', '<', \Carbon\Carbon::today())->update(['status' => 0]);
