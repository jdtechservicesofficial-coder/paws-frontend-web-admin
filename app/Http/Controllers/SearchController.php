...
class SearchController extends Controller
{
    ...
    public function get_order_status_data(Request $request)
    {
        ...
        if (isset($is_multiple) && count($is_multiple)) {
            ...
            if ($sub_type === 'ORDER_STATUS' && empty($itemsVal)) {
                $itemsVal = [
                    ['id' => 'order_placed', 'text' => 'Order Placed'],
                ...
                if ($keyword != '') {
                    $itemsVal = array_filter($itemsVal, function($item) use ($keyword) {
                        return strpos($item['id'], str_replace(' ', '_', strtolower($keyword))) !== false;
                    });
                }
            }
