...
function getAccessToken()
{
    ...
    if (empty($credentialsFiles)) {
        $rootFile = base_path('firebase-service-account.json');
        if (file_exists($rootFile)) {
            $credentialsFiles = [$rootFile];
        } else {
...
function get_pet_center_id(){
    ...
    return $pet_center ? $pet_center->id : null;
}
...
function getRevenueData(){
    ...
    // Add product orders revenue
    $TotalOrdersAmount = \Illuminate\Support\Facades\DB::table('order_groups')
