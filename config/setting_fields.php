...
return [
    'app' => [
        ...
        'elements' => [
            ...
            [
                ...
                'class' => '', // any class for input
                'value' => 'Copyright © 2026 PawandPaws Pet Store. All rights reserved.', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'general', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => 'required|min:2', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Copyright © 2026', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'general', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => 'required|min:2', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'admin@pawandpawspetstore.com.ng', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'general', // data type, string, int, boolean
    ...
    'mail' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Pawandpaws PetStore', // default value if you wantPassword
            ],
        ],
    ...
    'other_settings' => [
        ...
        'elements' => [
            [
                ...
                'label' => 'Social Login', // you know what label it is
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '0', // default value if you want
                'help' => 'Paste the only the Measurement Id of Google Analytics stream.', // Help text for the input field.
            ...
            [
                ...
                'label' => 'Google Login', // you know what label it is
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '0', // default value if you want
                'help' => 'Paste the only the Measurement Id of Google Analytics stream.', // Help text for the input field.
            ...
            [
                ...
                'label' => 'Apple Login', // you know what label it is
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '0', // default value if you want
                'help' => 'Paste the only the Measurement Id of Google Analytics stream.', // Help text for the input field.
            ...
            [
                ...
                'label' => 'OTP Login', // you know what label it is
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '0', // default value if you want
                'help' => 'Paste the only the Measurement Id of Google Analytics stream.', // Help text for the input field.
    ...
    'home_screen' => [
        'title' => 'Home Screen',
        'desc' => 'Configure Home Screen Services',
        'icon' => 'fas fa-home',
        'elements' => [
            [
                'type' => 'checkbox',
            ...
            [
                'type' => 'checkbox',
                'data' => 'home_screen',
                'name' => 'show_pet_sitter',
                'label' => 'Show Pet Sitters',
                'rules' => 'nullable',
                'class' => '',
                'value' => '1',
            ],
    ...
    'mobile_app_config' => [
        ...
        'desc' => 'Configure the mobile application endpoints',
        ...
        'elements' => [
            [
                ...
                'rules' => 'required|url',
                'class' => '',
                'value' => 'https://app.classicsolutionltd.com',
                'help' => 'This URL will be automatically sent to the Mobile App via Firebase Remote Config.',
            ],
        ],
    ],
