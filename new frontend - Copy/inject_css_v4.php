...
$css = '
    ...
    <style>
        ...
        section > .container p, .about-content p, .section-header p, .about-premium-list > p, .section-header .section-title { 
            color: #ffffff !important; 
        }
        ...
        /* 6. Fix images/dividers that sit on the blue background */
        .service-shape-bg, .section-header-shpae, .bg-shape { 
            filter: brightness(0) invert(1) !important; 
            opacity: 0.8 !important; 
        } 
    </style>
    <!-- END INJECTED THEME CSS v4 -->
';
...
foreach ($layouts as $file) {
    if (file_exists($file)) {
        ...
        echo "Injected CSS v4 into " . basename($file) . "!\n";
    }
}
