            ...
            <div class="card-body px-4">
                <form action="" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9 col-xs-12">
                                    <input class="form-control" type="text" name="cur_text" readonly
                                        value="{{$general->cur_text}}">
                                    <small class="text-muted">Manage currencies from Pawlly App Admin</small>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                ...
                                <div class="col-md-9 col-xs-12">
                                    <input class="form-control" type="text" name="cur_sym" readonly
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2 col-sm-6 mb-4">
                            <label class="fw-bold">@lang('Policy Agreement')</label>
                            <label class="switch m-0">
