    ...
    <div class="col-12">
        <div class="row">
                <div class="row gy-2 pb-2 gx-2">
                    <!-- Pawlly doesn't have a wallet/balance system for users, so these cards have been removed -->
                </div>
                <div class="card p-2">
                    <ul class="d-flex flex-wrap gap-1">
                        <!-- Balance buttons removed as Pawlly doesn't use the ViserLab wallet system -->
                        ...
                        <li class="flex-grow-1 flex-shrink-0">
                            @if($user->is_banned == 0)
                            <a class="d-block btn btn--primary userStatus" data-bs-toggle="modal"
                                data-bs-target="#userStatusModal" href="javascript:void(0)">
                                <i class="las la-ban"></i> @lang('Ban User')
                            </a>
                            @else
                            <a class="d-block btn btn--primary userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal"
                            ...
                            <div class="row">
                                <div class="form-group  col-xl-3 col-md-6 col-12">
                                    ...
                                    <label class="switch m-0">
                                        <input type="checkbox" class="toggle-switch" name="ev" {{ $user->email_verified_at ?
                                        'checked' : null }}>
        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin.users.status',$user->id)}}" method="POST">
                ...
                <div class="modal-body">
                    @if($user->is_banned == 0)
                    <h6 class="mb-2">@lang('If you ban this user he/she won\'t be able to access the app.')</h6>
                    <h4 class="text-center mt-3">@lang('Are you sure you want to ban this user?')</h4>
                    @else
                    <h4 class="text-center mt-3">@lang('Are you sure you want to unban this user?')</h4>
                    @endif
                </div>
