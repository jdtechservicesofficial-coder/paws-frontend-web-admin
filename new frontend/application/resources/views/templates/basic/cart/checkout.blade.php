                        ...
                        <div class="your-order">
                            ...
                            <table class="table table--responsive--lg mb-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td data-label="Subtotal">@lang('Subtotal')</td>
                                        <td data-label="Subtotal" id="subtotalAmount" data-subtotal="{{ $total - ($total * (Session::get('coupon')['discount'] ?? 0)) / 100 }}">
                                            {{ __($general->cur_sym) }}
                                            @if (Session::has('coupon'))
                                    ...
                                    <tr>
                                        <td data-label="Tax">@lang('VAT')</td>
                                        <td data-label="Tax" id="taxAmount" data-taxvalue="{{ $tax ? $tax->value : 0 }}" data-taxtype="{{ $tax ? $tax->type : 'fixed' }}">
                                    ...
                                    <tr class="fw-bold">
                                        <td data-label="Grand Total">@lang('Grand Total')</td>
                                        <td data-label="Grand Total" id="grandTotalAmount">
                                            {{ __($general->cur_sym) }} <span>0.00</span>
                                        </td>
                                    </tr>
                                </tbody>
