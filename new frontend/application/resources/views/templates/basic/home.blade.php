                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6">
                            <div class="banner-content">
                                <h1 class="title" style="color: #ffffff !important; font-size: clamp(28px, 6vw, 48px); font-weight: 800; line-height: 1.15; margin-bottom: 16px; text-shadow: 0 2px 10px rgba(0,0,0,0.15);">{{__($banner->data_values->heading)}}</h1>
                                <p style="color: rgba(255,255,255,0.92) !important; font-size: clamp(14px, 4vw, 16px); line-height: 1.7; margin-bottom: 24px;">{{__($banner->data_values->description)}}</p>
