...
<section class="call-to-action-section pt-120">
    <div class="container">
        <div class="call-to-action-thumb cta-premium-overlay">
            <img src="{{getImage(getFilePath('frontend').'/call_out/'.$content->data_values->background_image)}}"
                alt="call-to-action" style="width:100%; height:auto;">
            <div class="call-to-action-wrapper p-5">
                <div class="content">
                    <h2 class="title">{{__($content->data_values->heading)}}</h2>
                </div>
                <div class="btn-wrapper mt-4">
                    <a class="btn--base premium-btn"
