        ...
        <div class="row justify-content-center align-items-center mb-30">
            <div class="col-xl-6 col-lg-6 mb-30">
                <div class="section-header mb-4">
                    ...
                    <p style="color: #ffffff; font-size: clamp(13.5px, 3.5vw, 15px); line-height: 1.7;">{{__($content->data_values->subheading)}}</p>
                </div>
                <div style="background: #ffffff; border-radius: 20px; padding: 35px 30px; border: 1px solid #e2e8f0; box-shadow: 0 15px 35px -10px rgba(0,0,0,0.06);">
                    <form class="get-in-touch-form" action="{{ route('book.consultation') }}" method="post">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-primary w-100" style="height: 50px; font-weight: 700; font-size: clamp(13.5px, 3.5vw, 15px); border-radius: 10px; background: #fdcd01; border: none; box-shadow: 0 4px 14px rgba(37, 99, 235, 0.35); transition: all 0.2s;">
