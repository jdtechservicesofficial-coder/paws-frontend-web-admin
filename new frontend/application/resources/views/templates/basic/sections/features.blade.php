        ...
        <div class="row align-items-center mb-30-none">
            <div class="col-xl-5 col-lg-5 mb-30">
                <div class="section-header mb-0">
                    ...
                    <h2 class="section-title" style="font-weight: 800; color: #ffffff; font-size: clamp(20px, 4.5vw, 34px); line-height: 1.25; margin-top: 8px;">{{__($content->data_values->heading)}}</h2>
                    <img src="{{asset($activeTemplateTrue.'images/shape-blue.png')}}" alt="shape" class="section-header-shpae my-3" style="max-width: 80px;">
                    <p style="color: #ffffff; font-size: clamp(13.5px, 3.5vw, 15px); line-height: 1.7;">{{__($content->data_values->description)}}</p>
                </div>
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="feature-item" style="background: #f8fafc; border-radius: 16px; padding: 26px 22px; border: 1px solid #e2e8f0; transition: all 0.3s ease; height: 100%; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
                                <div class="thumb mb-3" style="display: inline-flex; align-items: center; justify-content: center; width: 52px; height: 52px; border-radius: 12px; background: #eff6ff; color: #2563eb; font-size: clamp(16px, 3.5vw, 22px);">
                                    @php echo $item->data_values->icon; @endphp
                                </div>
                                <div class="content">
                                    <h3 class="title" style="font-size: clamp(13.5px, 3.5vw, 17px); font-weight: 700; color: #1e293b; margin-bottom: 8px;">{{__($item->data_values->title)}}</h3>
