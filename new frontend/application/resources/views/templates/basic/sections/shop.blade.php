    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 text-center mb-5">
                <div class="section-header mb-0">
                    ...
                    <h2 class="section-title" style="font-weight: 800; color: #ffffff; font-size: clamp(24px, 5vw, 36px); line-height: 1.25; margin-bottom: 12px; letter-spacing: -0.5px;">{{ __($shop->data_values->subheading ?? 'Our Latest Collection') }}</h2>
                    <p style="color: #ffffff; font-size: clamp(13.5px, 3.5vw, 15px); line-height: 1.7; max-width: 600px; margin: 0 auto;">@php echo $shop->data_values->description @endphp</p>
                ...
                <div class="ecommerce-product" style="background: #ffffff; border-radius: 20px; border: 1px solid #e2e8f0; box-shadow: 0 6px 20px rgba(0,0,0,0.03); overflow: hidden; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); height: 100%; display: flex; flex-direction: column; justify-content: space-between;" onmouseover="this.style.transform='translateY(-6px)'; this.style.boxShadow='0 20px 35px -10px rgba(37,99,235,0.12)'; this.style.borderColor='#93c5fd';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 6px 20px rgba(0,0,0,0.03)'; this.style.borderColor='#e2e8f0';">
                    <div>
                        <div class="ecommerce-product__thumb" style="position: relative; background: #f8fafc; border-radius: 18px 18px 0 0; overflow: hidden; padding: 20px; text-align: center;">
                            <a href="{{ route('product.details', ['slug' => slug($product->name), 'id' => $product->id])}}" style="display: block; width: 100%; aspect-ratio: 1 / 1; overflow: hidden; border-radius: 8px;">
                                <img src="{{ $imageUrl }}" alt="{{ $product->name }}" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s ease; display: block;" onmouseover="this.style.transform='scale(1.06)'" onmouseout="this.style.transform='scale(1)'">
                            </a>
                        ...
                        <div class="ecommerce-product__content" style="padding: 20px 18px;">
                            ...
                            <h3 class="title mb-2" style="font-size: clamp(13.5px, 3.5vw, 16px); font-weight: 800; line-height: 1.4;">
                            ...
                            <div class="price-wrap d-flex align-items-center gap-2">
                                ...
                                <span class="product-price new" style="color: #2563eb; font-weight: 800; font-size: clamp(13.5px, 3.5vw, 17px); background: transparent; padding: 0;">{{ $general->cur_sym }}{{ showAmount(($product->price) - ($product->price * $product->discount/100 )) }}</span>
                                @else
                                <span class="product-price new" style="color: #0f172a; font-weight: 800; font-size: clamp(13.5px, 3.5vw, 17px); background: transparent; padding: 0;">{{__($general->cur_sym)}}{{showAmount($product->price)}}</span>
                                @endif
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mt-5">
            <div class="col-md-12 d-flex justify-content-center">
                <a href="{{route('shop')}}" class="btn btn--base" style="padding: 12px 36px; font-weight: 700; font-size: clamp(13.5px, 3.5vw, 15px); border-radius: 10px; box-shadow: 0 4px 14px rgba(37, 99, 235, 0.25);">@lang('Explore All Products') <i class="las la-arrow-right ms-1"></i></a>
            </div>
        </div>
