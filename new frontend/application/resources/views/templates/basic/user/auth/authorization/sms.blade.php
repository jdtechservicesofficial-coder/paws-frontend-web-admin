            ...
            <div class="col-xl-5 col-lg-6 col-md-8">
                <div style="background: #ffffff; padding: 45px 35px; border-radius: 16px; border: 1px solid #e2e8f0; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.05);">
                    <div class="text-center mb-4">
                        ...
                        <h3 style="font-weight: 700; color: #1e293b; font-size: 26px; margin-bottom: 8px;">@lang('Verify Mobile Number')</h3>
                        <p style="color: #64748b; font-size: 14px; margin-bottom: 4px;">@lang('A 6-digit verification code has been sent to')</p>
                        <span style="display: inline-block; background-color: #eff6ff; color: #1d4ed8; font-weight: 600; font-size: 14px; padding: 4px 12px; border-radius: 6px; margin-top: 6px;">+{{ showMobileNumber(auth()->user()->mobile) }}</span>
                    </div>
                    ...
                    <form action="{{route('user.verify.mobile')}}" method="POST" class="submit-form">
                        ...
                        <div class="text-center mt-4">
                            <p style="color: #64748b; font-size: 14px; margin-bottom: 8px;">
                                ...
                                <a href="{{route('user.send.verify.code', 'phone')}}" style="color: #2563eb; font-weight: 600; text-decoration: none;">@lang('Resend Code')</a>
                            </p>
