                ...
                <form action="{{route('user.deposit.insert')}}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header">
                            @lang('Pay') {{ $general->cur_sym }}{{ showAmount($package->price) }} @lang('For') {{
                            __($package->name) }} @lang('Package')
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" step="any" name="amount" class="form-control"
                                        value="{{ $package->price }}" autocomplete="off" required>
                                </div>
                            </div>
