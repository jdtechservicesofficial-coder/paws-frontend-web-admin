...
Route::middleware('admin')->group(function () {
    ...
    // Packages
    Route::controller('PackageController')->prefix('manage')->group(function(){
        ...
        Route::post('packages/{package}/update', 'update')->name('packages.update');
    });
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('manage/users')->group(function(){
     ...
     // shipping method
     Route::name('shipping.')->controller('ShippingController')->prefix('shipping')->group(function(){
    ...
    Route::controller('SubscriptionController')->group(function(){
        ...
        Route::post('subscriptions', 'search')->name('subscriptions.search');
    });

    // Consultation
    Route::controller('ConsultationController')->group(function(){
        Route::get('consultations', 'index')->name('consultations.index');
        Route::post('consultations', 'search')->name('consultations.search');
        Route::get('consultation/{id}', 'show')->name('consultation.show');
        Route::get('complete/{id}', 'complete')->name('consultation.complete');
    });
