        ...
        <div class="row g-0 w-100">
            ...
            <div class="col-lg-5 feature-banner">
                <div class="banner-logo">
                    @if(setting('logo'))
                        <img src="{{ asset(setting('logo')) }}" alt="{{ app_name() }}" onerror="this.style.display='none'; document.getElementById('forgot-logo-fallback').style.display='flex';">
                    @endif
                    <div id="forgot-logo-fallback" style="{{ setting('logo') ? 'display: none;' : 'display: flex;' }} align-items: center; gap: 10px;">
            ...
            <div class="col-lg-7 form-panel">
                <div class="form-container">
                    <div class="form-header">
                        ...
                        <p>No problem! Enter your registered email address and we'll send you a password reset link.</p>
                    </div>

                    <!-- Session Status -->
                    @if (session('status'))
                        <div style="background-color: #ecfdf5; border: 1px solid #a7f3d0; color: #065f46; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; font-size: 0.95rem;">
                            {{ session('status') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="input-group-custom">
                            ...
                            <input id="email" class="input-custom" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="name@example.com">
                        </div>
