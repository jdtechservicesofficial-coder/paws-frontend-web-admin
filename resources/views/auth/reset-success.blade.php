<x-auth-layout>
    <x-slot name="title">
        @lang('Password Reset Successful')
    </x-slot>
        ...
        <div class="row g-0 w-100">
            ...
            <div class="col-lg-5 feature-banner">
                <div class="banner-logo">
                    @if(setting('logo'))
                        <img src="{{ asset(setting('logo')) }}" alt="{{ app_name() }}" onerror="this.style.display='none'; document.getElementById('success-logo-fallback').style.display='flex';">
                    @endif
                    <div id="success-logo-fallback" style="{{ setting('logo') ? 'display: none;' : 'display: flex;' }} align-items: center; gap: 10px;">
            ...
            <!-- Right Side Confirmation Column -->
            <div class="col-lg-7 form-panel">
                <div class="form-container">
                    ...
                    <p class="success-desc" style="margin-bottom: 0;">
                        Your password has been updated successfully.<br>
                        Please return to your mobile app to sign in with your new credentials.
                    </p>
                </div>
            </div>
        </div>
