...
@section('content')
    <style>
        ...
        .dashboard-pro .card-body {
            padding: 1.5rem;
        }
        .dark .dashboard-pro .card {
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2);
        }
        .dark .dashboard-pro .card:hover {
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                                                ...
                                                <h3 class="mb-0">
                                                    {{ Currency::format($data['total_amount']) }}
                                                </h3>
                                                <div class="position-absolute top-0 end-0 mt-3 me-3">
                                                    <span class="info-icon text-primary" data-toggle="tooltip" data-placement="top" title="Total Revenue = SUM of (total_amount of completed bookings with successful payments)">
                                ...
                                <div class="col-sm-6 col-xxl-3 col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="position-absolute top-0 end-0 mt-3 me-3">
                                                <span class="info-icon text-primary" data-toggle="tooltip" data-placement="top" title="Profit = admin_earnings from revenue data">
                                                    <i class="fas fa-info-circle"></i>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-12 col-xxl-6">
                                            ...
                                            <div class="d-flex align-items-center mb-4">
                                                ...
                                                <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="6" cy="6" r="6" fill="var(--bs-primary)" />
                                                </svg>
                                                <strong>
...
@push('after-scripts')
    ...
    if (total_sale_count.length === 0 || total_sale_count.every(count => count === 0)) {
        name.push('No Data');
        total_sale_count.push(0);
    }
        ...
        chart: {
            ...
            events: {
                dataPointSelection: function(event, chartContext, config) {
                    // Prevent hiding chart when there is no data
                    if (config.w.globals.series[config.dataPointIndex] === 0) {
    ...
    chart.render();
            ...
            if (document.querySelectorAll('#chart-06').length) {
                ...
                topservice.forEach(service => {
                    servicename.push(service.service.name)
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (document.querySelectorAll('#chart-05').length) {
                        ...
                        console.log(total_bookings_status)
                        ...
                        var options = {
                            ...
                            labels: [
                                '<strong style="color:#9D67EF;">Pending</strong><br>Bookings', // Color matching the slice
                                '<strong style="color:#CEADFF;">Confirmed</strong><br>Bookings', // Color matching the slice
                                '<strong style="color:#E6D6FF;">Cancelled</strong><br>Bookings', // Color matching the slice
                                '<strong style="color:#F0F0F0;">Rejected</strong><br>Bookings', // Color matching the slice
                                '<strong style="color:#ECE0FF;">Complete</strong><br>Bookings' // Color matching the slice
                            ],
                            legend: {
                                show: false
                            }
